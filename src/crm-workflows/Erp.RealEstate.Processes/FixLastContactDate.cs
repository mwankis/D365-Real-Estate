...
namespace Erp.RealEstate.Processes
{
    public class ProcessNextContactDate : CodeActivity
    {
        ...
        public OutArgument<int> ActivityCount { get; set; }
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            executionContext.SetValue(DueDate, earliestDateObj.DueDate);
            executionContext.SetValue(ActivityCount, earliestDateObj.ActivityCount);
        }
